...
tit = [1, 1, 2, 3, 3, 2, 3, 3, 3, 3, 2, 3, 2, 2, 2, 3, 3, 3, 2, 3, 2, 2, 2, 3, 2, 3, 3, 3, 2, 3, 3, 3, 1, 4, 1, 3, 2, 3, 1, 2, 3, 1, 3, 1, 3, 1]
...
#list_attacker = ['PF-5','PF-6','PF-7','PF-8','PF-9']
...
for attacker in list_attacker:
    ...
    with open("set_request.json", "r") as c:
        ...
        try:
            ...
            '''
            try: 
                driver.find_element_by_xpath("//span[@class='tojvnm2t a6sixzi8 abs2jz4q a8s20v7p t1p8iaqh k5wvi7nf q3lfd5jv pk4s997a bipmatt0 cebpdrjk qowsmv63 owwhemhu dp1hu0rb dhp61c6y iyyx5f41']").click()
                time.sleep(3)
                driver.find_element_by_xpath("//div[@class='n00je7tq arfg74bv qs9ysxi8 k77z8yql i09qtzwb n7fi1qx3 b5wmifdl hzruof5a pmk7jnqg j9ispegn kr520xx4 c5ndavph art1omkt ot9fgl3s rnr61an3']").click()
                time.sleep(3)
            except:
                print(Exception)
            '''
