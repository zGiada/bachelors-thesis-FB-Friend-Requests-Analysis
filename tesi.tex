...
\input{capitoli/capitolo-2}     % Description internship
\input{capitoli/capitolo-3}     % Background
\input{capitoli/capitolo-4}     % Literature
\input{capitoli/capitolo-5}     % Structure design
\input{capitoli/capitolo-6}     % Development of the tools
\input{capitoli/capitolo-7}     % Data collection
\input{capitoli/capitolo-8}     % Data analysis
\input{capitoli/capitolo-9}     % Future works
\input{capitoli/capitolo-10}    % Conclusions
\appendix                               
